...
?>
 ...
 <!--Change Survey Success -->
 <!--Ember Adkins 901893134-->
 <head>
     <title>Change Survey Success</title>
    <meta charset="UTF-8">
...
<h1>Welcome</h1>
    ...
    <p>The table has been successfully updated with your information!</p>
            <p><a href="surveyorSelectSurveytoEdit.php">
            <button class="btn"><i class="fa-solid fa-gear"></i> Edit Another </button>
            </a> </p>
